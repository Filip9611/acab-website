...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-x-clip border-t border-white/10 bg-black">
      {/* Main grid */}
      <div className="mx-auto max-w-7xl px-[5vw] pb-16 pt-24 md:pb-20 md:pt-32">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-4 gap-y-2 px-[5vw] py-6 text-center font-sans text-[10px] uppercase tracking-[0.3em] text-white/40">
          <span>
